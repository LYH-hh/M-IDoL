...
try:
    from tutel_ import moe as tutel_moe
except:
    tutel_moe = None
...
def swin_base(num_classes=0, **kwargs):
...
class MoEMlp(nn.Module):
    ...
    def forward(self, x):
        x, rout_logits = self._moe_layer(x)
        return x, rout_logits
...
class MoEHead(nn.Module):
    def __init__(self, in_dim, 
        ...
        super().__init__()
        self.mlp = MoEMlp(in_features=in_dim,
